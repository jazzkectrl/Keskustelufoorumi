...
<head>
    ...
    <title>Jarkon palsta - yleinen keskustelu</title>
...
<!-- navigointipalkki -->
    ...
    <div class="container">
        ...
        foreach ($postaukset as $postaus) {
            ...
            $comments = tuoKommentti($postaus['id']);
            foreach ($comments as $comment) {
                echo "<div class='mt-2'>";
                echo "<p style = 'color: blue;'>" . $comment['kommentti_sisalto'] . "</p>";
                echo "<p class='text-muted'>" . $comment['kommentti_pvm'] . " UTC</p>";
                echo "</div>";
            }
            echo "</div>";
            echo "</div>";
