...
function syotaKommentti($post_id, $kommentti_sisalto) {
    ...
    try {
        ...
        $sql = "INSERT INTO urheilu_kommentit (kommentti_id, post_id, kommentti_sisalto, kommentti_pvm) VALUES (NULL, :post_id, :kommentti_sisalto, NOW())";
...
function tuoKommentti($post_id) {
    ...
    try {
        ...
        $sql = "SELECT * FROM urheilu_kommentit WHERE post_id = :post_id";
        $stmt = $conn->prepare($sql);
